      ...
      <div className="relative grid grid-cols-[auto_1fr] gap-6 p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {question.is_followers_only && (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-blue-500 dark:text-blue-400 flex-shrink-0" title="Apenas seguidores">
